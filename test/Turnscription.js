...
describe("Turnscription - Random Comparison", function () {
  ...
  let Turnscription;  // Turnscription合约对象
  let game;        // Turnscription部署对象
  let admin;
  let player1;
  let player2;
  ...
  before(async function () {
    ...
    // 部署Turnscription合约
    Turnscription = await ethers.getContractFactory("Turnscription");
    game = await Turnscription.deploy();
